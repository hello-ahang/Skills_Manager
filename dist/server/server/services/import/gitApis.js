...
// ==================== GitHub API ====================
export async function githubApiFetch(url, token) {
    const headers = {
...
export async function getGitHubRepoInfo(owner, repo, token) {
 ...
 */
export async function downloadRepoAsZip(zipUrl, targetDir, headers) {
...
// ==================== Gitee API ====================
export async function giteeApiFetch(url, token) {
    const headers = {
...
export async function getGiteeRepoInfo(owner, repo, token) {
...
// ==================== GitLab API ====================
export async function gitlabApiFetch(host, endpoint, token) {
    const headers = {
        'Accept': 'application/json',
        'User-Agent': 'Skills-Manager/2.0',
    };
...
export async function getGitLabRepoInfo(host, projectPath, token) {
...
// ==================== Bitbucket API ====================
export async function bitbucketApiFetch(url) {
...
export async function getBitbucketRepoInfo(owner, repo) {
    ...
    return {
        ...
        branches: branchesData.values?.map((b) => b.name) || [],
        url: data.links?.html?.href || `https://bitbucket.org/${owner}/${repo}`,
    };
}
export async function downloadBitbucketContents(owner, repo, dirPath, branch, targetDir) {
