...
function codebuddyToClaude(content) {
    return `# CodeBuddy Rules Migration\n\n${content}`;
}
function claudeToCodebuddy(content) {
    return content;
}
function genericConvert(content, from, to) {
...
export function convertContent(content, from, to) {
    const key = `${from}->${to}`;
...
export async function convertFiles(files, from, to, outputDir) {
...
// ==================== Diff ====================
export function computeDiff(content1, content2) {
