...
export async function getLinkInfo(targetPath) {
    try {
...
export async function createSymlink(options) {
...
export async function removeSymlink(targetPath, restoreAsDirectory = false) {
...
export async function verifySymlink(targetPath) {
    const linkInfo = await getLinkInfo(targetPath);
    if (!linkInfo.isSymlink || !linkInfo.linkedTo)
        return false;
